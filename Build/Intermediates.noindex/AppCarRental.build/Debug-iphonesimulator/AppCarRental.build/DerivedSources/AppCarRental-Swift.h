...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AppCarRental",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12AppCarRental11AppDelegate")
...
SWIFT_CLASS("_TtC12AppCarRental13SceneDelegate")
...
SWIFT_CLASS("_TtC12AppCarRental14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified facebookButton;
- (void)viewDidLoad;
- (IBAction)webSiteTapped:(id _Nonnull)sender;
- (IBAction)facebookTapped:(id _Nonnull)sender;
